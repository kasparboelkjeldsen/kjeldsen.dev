...
"csharp": () => import('@shikijs/langs/csharp').then(r => r.default || r),
"c#": () => import('@shikijs/langs/csharp').then(r => r.default || r),
"cs": () => import('@shikijs/langs/csharp').then(r => r.default || r),
"vue-html": () => import('@shikijs/langs/vue-html').then(r => r.default || r),
...
const options = {"theme":"github-dark","wrapperStyle":true}
