...
import { consola } from 'file://X:/kasparboelkjeldsen/kjeldsen.dev/kjeldsen.frontend/node_modules/consola/dist/index.mjs';
...
const logger = consola.withTag("nuxt-multi-cache");
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "699ff1cf-d454-4fa2-9d42-f3817b6318ff",
...
storage.mount('internal:nuxt:prerender', file_58_47_47_47X_58_47kasparboelkjeldsen_47kjeldsen_46dev_47kjeldsen_46frontend_47node_modules_47nuxt_47dist_47core_47runtime_47nitro_47utils_47cache_45driver_46js({"driver":"file:///X:/kasparboelkjeldsen/kjeldsen.dev/kjeldsen.frontend/node_modules/nuxt/dist/core/runtime/nitro/utils/cache-driver.js","base":"X:/kasparboelkjeldsen/kjeldsen.dev/kjeldsen.frontend/.nuxt/cache/nitro/prerender"}));
...
const _A73Z7F = eventHandler((event) => {
...
const _lazy_sFjQTo = () => import('../routes/api/github/callback.mjs');
const _lazy_SEwznU = () => import('../routes/api/murder/list.get.mjs');
const _lazy_JA75IE = () => import('../routes/api/murder/push.post.mjs');
const _lazy_pkLN9i = () => import('./renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _A73Z7F, lazy: false, middleware: true, method: undefined },
