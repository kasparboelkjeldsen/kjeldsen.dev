...
const _sfc_main$6 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d;
      const _component_MDCRenderer = _sfc_main$7;
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      const _component_MDC = _sfc_main$6;
...
const BlocksFunTimeWebEkg = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-6ffea522"]]);
